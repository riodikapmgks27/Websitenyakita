...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    let hargaDomain = 0;
    let hargaHosting = 64000 * durasi; // Basic Starter
...
localStorage.setItem("inv_nama", nama);
localStorage.setItem("inv_paket", paket);
localStorage.setItem("inv_harga", harga);
localStorage.setItem("inv_durasi", durasi);
localStorage.setItem("inv_domain", domain);
localStorage.setItem("inv_status", "Menunggu Verifikasi");
